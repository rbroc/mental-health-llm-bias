...
RESPONSES = {
    ...
    "multiclass": "Which psychiatric condition AUXVERB PERSON more likely to have? You must choose between CONDOPTIONS. Only respond with the name of the condition. Condition:",
}
